...
final class ViewModelWatch: ObservableObject {
    
    private let hapticsManager = HapticsManagerWatch()
    let sessionManager = SessionManagerWatch()
...
private extension ViewModelWatch {
